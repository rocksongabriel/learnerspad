...
class TestUserProfileCreation:
    ...
    def test_developer_user_profile_creation(self, developer_user):
        ...
        assert profile.user.username == developer_user["username"]

    def test_student_user_profile_creation(self, student_user):
        ...
        assert profile
        assert profile.user.username == student_user["username"]